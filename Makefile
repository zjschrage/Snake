...
DEPS_BUTTON = button/button.cpp button/button_toggle.cpp button/button_play.cpp button/button_settings.cpp button/button_help.cpp button/button_menu.cpp button/button_audio.cpp button/button_wrap.cpp
