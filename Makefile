...
DEPS_GAME = snake_game.cpp game/snake.cpp game/grid.cpp game/cell.cpp game/direction.cpp game/game_variables.cpp
...
DEPS_BUTTON = button/button.cpp button/button_play.cpp button/button_settings.cpp button/button_help.cpp button/button_menu.cpp button/button_audio.cpp
